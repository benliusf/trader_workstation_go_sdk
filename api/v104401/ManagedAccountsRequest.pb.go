...
var file_ManagedAccountsRequest_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x42, 0x46, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x62, 0x2e, 0x63, 0x6c, 0x69,
	0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x42, 0x1b, 0x4d, 0x61,
	0x6e, 0x61, 0x67, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x71,
...
var (
	...
	file_ManagedAccountsRequest_proto_rawDescData = file_ManagedAccountsRequest_proto_rawDesc
)

func file_ManagedAccountsRequest_proto_rawDescGZIP() []byte {
	file_ManagedAccountsRequest_proto_rawDescOnce.Do(func() {
		file_ManagedAccountsRequest_proto_rawDescData = protoimpl.X.CompressGZIP(file_ManagedAccountsRequest_proto_rawDescData)
	})
...
var file_ManagedAccountsRequest_proto_goTypes = []interface{}{
...
func file_ManagedAccountsRequest_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ManagedAccountsRequest_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ManagedAccountsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ManagedAccountsRequest_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_ManagedAccountsRequest_proto_rawDesc = nil
