...
// An example to test the client connection to TWS localhost:7497
// You should see the following output in stdout -
//		2026/03/17 13:36:49 [INFO] client=0 connected to localhost:7497 ver=222 ts=2026-03-17 06:36:49 -0700 PDT
